 ...
 */
public class Test_ListAdapter_BTLE_Devices extends ArrayAdapter<Test_BTLE_Device> {

    Context context;
    int layoutResourceID;
    ArrayList<Test_BTLE_Device> devices;


    public Test_ListAdapter_BTLE_Devices(Context context, int resource, ArrayList<Test_BTLE_Device> objects) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Test_BTLE_Device device = devices.get(position);
