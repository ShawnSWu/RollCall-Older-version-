 ...
 */
public class RollCall_Scanner_BTLE {

    private RollCall_BLE_MainActivity ma;
    ...
    public RollCall_Scanner_BTLE(RollCall_BLE_MainActivity mainActivity, long scanPeriod, int signalStrength) {
        ma = mainActivity;
