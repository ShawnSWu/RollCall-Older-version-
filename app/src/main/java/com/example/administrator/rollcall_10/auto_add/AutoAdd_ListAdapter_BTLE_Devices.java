 ...
 */
public class AutoAdd_ListAdapter_BTLE_Devices extends ArrayAdapter<Auto_BTLE_Device> {

    Context context;
    int layoutResourceID;
    ArrayList<Auto_BTLE_Device> devices;


    public AutoAdd_ListAdapter_BTLE_Devices(Context context, int resource, ArrayList<Auto_BTLE_Device> objects) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Auto_BTLE_Device device = devices.get(position);
