 ...
 */
public class AutoAdd_ListAdapter_BTLE_Services extends BaseExpandableListAdapter {
    ...
    public AutoAdd_ListAdapter_BTLE_Services(Activity activity, ArrayList<BluetoothGattService> listDataHeader,
