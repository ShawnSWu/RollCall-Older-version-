 ...
 */
public class RollCall_ListAdapter_BTLE_Services extends BaseExpandableListAdapter {
    ...
    public RollCall_ListAdapter_BTLE_Services(Activity activity, ArrayList<BluetoothGattService> listDataHeader,
